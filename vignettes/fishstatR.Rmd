...
```{r dataset_dimensions, eval=F, include=TRUE}
...
```{r dimension_groups, eval=F, include=TRUE}
 metadata <- ReadMetadata()
...
The result can be resolved to a grouping by `ReadEBXHierarchy()`
